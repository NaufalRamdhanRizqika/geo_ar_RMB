// =============================================================================
// GEOTHERMAL AR - SCENE CONFIGURATION (FINAL FIX)
// =============================================================================
// ✅ Camera zoom dengan format string "x y z"
// ✅ Kipas turbine di COVER SILVER (sebelah generator hijau)
// ✅ Kipas berputar horizontal seperti ban mobil
// =============================================================================
...
window.SCENE_CONFIG = [
    ...
    // SCENE 3: PRODUCTION WELL - Zoom ke KIRI BAWAH (sumur produksi)
    {
        id: 3,
    ...
    // SCENE 5: TURBINE - Zoom CLOSE ke COVER SILVER (kipas di dalamnya)
    {
        id: 5,
    ...
    // SCENE 6: GENERATOR - Zoom ke GENERATOR HIJAU (sebelah kanan cover silver)
    {
        id: 6,
        title: "Generator",
    ...
    // SCENE 7: COOLING TOWER - Zoom ke ATAS BELAKANG (menara pendingin)
    {
        id: 7,
        title: "Cooling Tower",
    ...
    // SCENE 8: INJECTION WELL - Zoom ke KANAN BAWAH (sumur injeksi)
    {
        id: 8,
    ...
    // SCENE 9: RESERVOIR - Zoom SANGAT BAWAH (reservoir panas bumi)
    {
        id: 9,
    ...
    // SCENE 11: FULL CYCLE - Zoom OUT lihat SEMUA dengan kipas berputar
    {
        id: 11,
...
console.log('📷 Camera: String format "x y z" untuk compatibility');
console.log('🌀 Turbine: Di cover SILVER (x: -0.04) sebelah generator hijau');
console.log('🔄 Turbine: Rotasi Z=90, berputar di axis Z (horizontal seperti ban)');
console.log('🔍 Camera zoom: Fokus ke setiap komponen spesifik');